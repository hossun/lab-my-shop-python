...
from PolicyHandler import wheneverOrderPlaced_DecreaseStock
from PolicyHandler import wheneverOrderCancelled_IncreaseStock
...
def consume(msg):
    ...
    if data['eventType'] == "OrderPlaced":
        wheneverOrderPlaced_DecreaseStock(data)
    if data['eventType'] == "OrderCancelled":
        wheneverOrderCancelled_IncreaseStock(data)
